<?php
if (!function_exists('wi_google_fonts')){
...
if (!function_exists('wi_fallback_font_array')){
function wi_fallback_font_array(){
...
if (!function_exists('wi_font_array')){
function wi_font_array(){
	return array_merge (wi_fallback_font_array(),wi_google_fonts());
}
}